...
class CRSDatasetRec:
    def __init__(self, args):
        ...
        self.all_movies = json.load((open(os.path.join(self.args.home, 'data/content_data.json'), 'r', encoding='utf-8')))[0]
    ...
    def _load_data(self):
        data_path = ''
        if "augment" in self.args.data_type:
            data_path = os.path.join(self.data_path, 'augment')
        elif 'explanation' in self.args.data_type:
            data_path = os.path.join(self.data_path, 'explanation')
        elif 'cot' in self.args.data_type:
            data_path = os.path.join(self.data_path, 'cot')
        elif 'refined' in self.args.data_type:
            data_path = os.path.join(self.data_path, 'refined')
        ...
        if data_path != '':
            ...
            with open('data/redial/augment/valid_data_augment.json', 'w', encoding='utf-8') as f:
